        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-[#64748B]">
              Join ClariChain to start verifying documents with AI and blockchain
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-[#1E293B]">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-[#64748B]" />
            ...
            <div className="text-center text-sm text-[#64748B]">
              ...
              <Link href="/auth/login" className="text-[#2453CC] hover:underline">
                Sign in
              </Link>
            </div>
          </CardContent>
