      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-[#64748B]">Sign in to your ClariChain account</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/forgot-password" className="text-sm text-[#2453CC] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="text-center text-sm text-[#64748B]">
              ...
              <Link href="/auth/signup" className="text-[#2453CC] hover:underline">
                Sign up
              </Link>
            </div>
          </CardContent>
