  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <UploadBtnSheet>
          <div className=" shadow-sm hover:shadow-md transition-shadow cursor-pointer bg-gradient-to-br from-[#2453CC]/5 to-[#2453CC]/10 border-[#2453CC]/20 rounded-md">
        ...
        <Link
          ...
          className=" shadow-sm hover:shadow-md transition-shadow cursor-pointer bg-gradient-to-br from-[#38B26C]/5 to-[#38B26C]/10 border-[#38B26C]/20 rounded-md"
        >
          <CardContent className="p-6 text-center">
        ...
        <Link
          ...
          className=" shadow-sm hover:shadow-md transition-shadow cursor-pointer bg-gradient-to-br from-[#F59E0B]/5 to-[#F59E0B]/10 border-[#F59E0B]/20 rounded-md"
        >
          <CardContent className="p-6 text-center">
