      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div className="w-16 h-1 bg-gray-200">
            <div
              className={`h-full bg-[#2453CC] transition-all duration-300 ${
                uploadStep >= 2 ? "w-full" : "w-0"
              }`}
            ></div>
          </div>
          <div
              ...
              >
                ...
                {selectedFile && (
                  <div className="flex items-center justify-center space-x-2 mt-4 p-3 bg-[#38B26C]/10 rounded-lg">
                    ...
                    <span className="text-[#38B26C] font-medium">
                      {selectedFile.name}
                    </span>
      ...
      {uploadStep === 3 && (
        <Card className="border-0 shadow-lg">
          <CardHeader>
            ...
            <CardDescription className="text-[#64748B]">
              Your document has been successfully processed and is ready for AI
              analysis
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B] mb-2">
                    &quot;{documentTitle}&quot; has been processed and is ready
                    for AI analysis.
                  </p>
            ...
            <div className="bg-[#F59E0B]/10 border border-[#F59E0B]/20 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#64748B]">
                    Your document is now ready for AI-powered analysis. You can
                    review the plain-language summary, invite co-signers, and
                    eventually mint an NFT once all parties approve.
                  </p>
                </div>
              </div>
            </div>
