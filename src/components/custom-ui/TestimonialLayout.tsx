      ...
      <div className="testimonial-grid">
        ...
        <div className="testimonial-content">
          <AnimatePresence mode="wait">
            ...
            >
              <h3
                className="name !text-blue-600"
                style={{ color: colorName, fontSize: fontSizeName }}
              >
                {activeTestimonial.name}
              </h3>
              <p
                className="designation !text-black/50"
                style={{
          ...
          <div className="arrow-buttons">
            <button
              className="arrow-button prev-button !bg-blue-600"
              onClick={handlePrev}
              style={{
            ...
            <button
              className="arrow-button next-button !bg-blue-600 hover:bg-blue-700"
              onClick={handleNext}
              style={{
