...
export function Features() {
  return (
    <section className="bg-gray-50 py-16 md:py-32 !pb-0 dark:bg-transparent">
      <div className="mx-auto w-full px-6 md:px-[70px] space-y-10">
        <div>
          <h2 className="text-balance text-4xl sm:text-5xl font-medium md:text-6xl mb-2">
            Simplify. <span className="text-blue-600">Sign.</span> Store.
          </h2>
          <p className="text-muted-foreground text-base md:text-lg max-w-[800px] text-balance">
            ...
            ClariChain helps individuals and teams simplify complex contracts
            and prove compliance where it matters.
          </p>
        </div>
          ...
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  <svg
                    className="text-blue-600 absolute inset-0 size-full"
                    viewBox="0 0 254 104"
                    fill="none"
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold text-blue-600">
                    100%
                  </span>
                </div>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:border-blue-800/30 dark:border-white/10 dark:before:border-blue-600/5">
                  <svg
                    className="m-auto h-fit w-24 text-blue-600"
                    viewBox="0 0 212 143"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path
                      className="text-blue-300 dark:text-zinc-600"
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Each document gets a cryptographic fingerprint, proving it’s
                    yours — secure, unique, and tamper-proof.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  <svg
                    className="text-blue-600 dark:text-muted-foreground w-full max-h-40"
                    viewBox="0 0 400 140"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    ...
                    <g
                      ...
                      fill="currentColor"
                    >
                      <path d="M260 40L264 50L270 52L264 54L260 64L256 54L250 52L256 50L260 40Z" />
                      <path d="M300 70L302 75L308 76L302 78L300 84L298 78L292 76L298 75L300 70Z" />
                      <path d="M280 100L282 105L288 106L282 108L280 114L278 108L272 106L278 105L280 100Z" />
                    </g>
                    <rect
                      x="220"
                      y="40"
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    AI reads and explains your document in seconds. No jargon —
                    just clear summaries and ELI5 breakdowns.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 items-center justify-center rounded-full border dark:border-white/10 bg-muted">
                    <ListChecks
                      className="size-5 dark:text-primary-500"
                      strokeWidth={1.5}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Get a quick snapshot of who’s signed, who’s pending, and
                      what’s coming next — all in one place.
                    </p>
                  </div>
                </div>

                <div className="mt-6 sm:ml-6">
                  {/* Replace this with a chart or simpler, thematic SVG illustration */}
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Co-signers verify and sign with one click. Every action is
                      locked on the blockchain for permanent proof.
                    </p>
                  </div>
                </div>
